...
// -------------------------------------------------------------
    CHK_ERR(DDERR_ALREADYINITIALIZED, "This object is already initialized")
        ...
        CHK_ERR(DDERR_INVALIDSTREAM, "The specified narrow_stream contains invalid data")
        ...
        CHK_ERR(DIERR_CANCELLED, "The user cancelled the install operation. & The narrow_stream already has allocated samples and the surface doesn't match the sample format.")
...
CHK_ERR(WINCODEC_ERR_BADSTREAMDATA, "Invalid narrow_stream data found in WIC image.")
CHK_ERR(WINCODEC_ERR_STREAMWRITE, "WIC operation on write narrow_stream failed.")
CHK_ERR(WINCODEC_ERR_STREAMREAD, "WIC operation on read narrow_stream failed.")
CHK_ERR(WINCODEC_ERR_STREAMNOTAVAILABLE, "Required narrow_stream is not available.")
