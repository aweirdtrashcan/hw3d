...
void PointLight::SpawnControlWindow() noexcept
{
	...
	{
		ImGui::Text("Position");
		ImGui::SliderFloat("X", &cbCpu.lightPos.x, -360.f, 360.f, "%.1f");
		ImGui::SliderFloat("Y", &cbCpu.lightPos.y, -360.f, 360.f, "%.1f");
		ImGui::SliderFloat("Z", &cbCpu.lightPos.z, -360.f, 360.f, "%.1f");
